...
/* Hardware */
#define HARDWARE_MODEL "C6 5CH LED DRIVER AIOv3"
...
#define BOARD_GPIO_MAP { GPIO_NUM_3, GPIO_NUM_5, GPIO_NUM_15 }
 ...
 * 20kHz = 11 bits
 * */
#define DUTY_STEPS          2047

#define LED_SETTINGS_VERSION 0x01
#define SCHEDULE_CONFIG_SETTINGS_VERSION 0x01
