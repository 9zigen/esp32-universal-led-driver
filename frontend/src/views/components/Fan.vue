    ...
    <div class="columns is-marginless is-multiline">
        <div class="column is-12 has-text-left">
            ...
            <div class="box">
                ...
                <div class="field is-horizontal">
                    <div class="field-label is-normal">
                        <label class="label">Use PID</label>
                    </div>
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <toggle-switch
                                    v-model="deviceCooling.use_pid"
                                    round
                                />
                            </div>
                        </div>
                ...
                <div v-show="deviceCooling.use_pid">
                    <!-- Start Temperature -->
                    <div class="field is-horizontal">
                        <div class="field-label is-normal">
                    ...
                    <div class="field is-horizontal">
                        ...
                        <div class="field-body">
                            <div class="field has-addons">
                                <div class="control">
                                    <input-number
                                        v-model.number="deviceCooling.pwm_duty"
                                        class="input"
            ...
            <!-- Fan PID -->
            <span
                v-show="deviceCooling.use_pid"
                class="subtitle is-4 is-uppercase has-text-grey-light">Fan PID</span>
            <div
                v-show="deviceCooling.use_pid"
                class="box">
                <!-- Proportional gain -->
