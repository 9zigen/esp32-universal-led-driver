...
<!--                      />-->
                ...
                <div class="field">
                  <div class="control">
                    <a
                      ...
                      @click="runDemo"
                    ><vue-feather type="play" /> {{ run_demo_label }}</a>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="column is-12 is-hidden-tablet">
                      <div class="field has-addons has-addons-centered">
                        <div class="control">
                          ...
                          ><vue-feather type="copy" class="mr-2"/> Copy</span>
                        </div>
                        <div class="control">
                          <span
                            class="button is-primary"
                            @click="applyTimePoint(index)"
                          ><vue-feather type="check" class="mr-2"/>Now</span>
                        </div>
                        <div class="control">
                          <span
                            class="button is-danger"
                            @click="deleteTimePoint(index)"
                          ><vue-feather type="x" class="mr-2"/> Delete</span>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="field">
                        <div class="control has-text-centered">
                          <span
                            class="button is-light"
                            @click="copyTimePoint(index)"
                          ><vue-feather type="copy" /></span>
                        </div>
                        <div class="control has-text-centered mt-2">
                          <span
                            class="button is-primary"
                            @click="applyTimePoint(index)"
                          ><vue-feather type="check" /></span>
                        </div>
                        <div class="control has-text-centered mt-2">
                          <span
                            class="button is-danger"
                            @click="deleteTimePoint(index)"
                          ><vue-feather type="x" /></span>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <div class="buttons is-centered">
      <span
        ...
        class="button is-light"
        @click="addTimePoint"
      ><vue-feather type="plus" />Add</span>
      <span
        class="button is-primary"
        @click="saveSchedule"
      ><vue-feather type="check" /> Save and continue</span>
      <span
        v-if="scheduleConfig.mode"
        class="button is-ghost is-info"
        @click="runDemo"
      ><vue-feather type="play" /> {{ run_demo_label }}</span>
      <span
        class="button is-danger"
        @click="reloadSchedule"
      ><vue-feather type="x" /> Cancel</span>
    </div>
  </div>
</template>
